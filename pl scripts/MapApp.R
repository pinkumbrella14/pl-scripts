...
suppressMessages(PackageLoader( c("dplyr", "reshape2", "lubridate", "tidyr", "rgdal", "ggplot2", "grid", "ggpubr", "leaflet", "maps", "rgeos", "htmltools", "htmlwidgets", "shiny", "shinyjs", "data.table") ))
